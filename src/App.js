      ...
      <main>
        ...
        <h4 className='hidden lg:block -rotate-90 absolute -left-10rem font-bold text-6xl text-center translate-y-15rem opacity-40'>CREATE WITH ME</h4>
          <div className='z-20 relative w-2/3 pr-1rem pb-1rem'>
            <div className='h-10rem md:h-12rem lg:h-16rem bg-color rounded-lg flex p-4rem justify-center lg:justify-end items-center'>
          ...
          <div className='z-20 relative w-3/5 pr-1rem pt-1rem'>
            <div className='h-10rem md:h-12rem lg:h-16rem bg-color rounded-lg flex p-4rem justify-center lg:justify-end items-center'>
              ...
              <div className='flex flex-col justify-center items-center'>
                ...
                <p className='text-1xl md:text-3xl font-semibold underline underline-offset-2 hover:text-light'><a href='' target='_blank' rel='noopener noreferrer'>Click here</a></p>
              </div>
            </div>
          </div>
