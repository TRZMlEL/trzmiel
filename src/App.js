  ...
  return (
    <div className='bg-dark w-screen text-light font-Lato'>
      ...
      <main>
        ...
        <section className=' z-40 relative section bg-color w-screen pl-16rem pr-16rem pt-4rem pb-4rem' id='about'>
        ...
        <h4 className='-rotate-90 absolute -left-10rem font-bold text-6xl text-center translate-y-15rem opacity-40'>CREATE WITH ME</h4>
          ...
          <div className='w-2/5 pl-1rem pt-1rem'>
            <div className='z-0 h-16rem bg-color rounded-lg'>
              <img className='z-10 -translate-x-0rem -translate-y-8rem absolute w-35rem' alt=' ' src={ HexSkillsDecoration }/>
            </div>
          </div>
        </section>
        <section className='z-20 relative section pt-4rem pb-4rem pr-16rem pl-16rem bg-color flex flex-col items-center' id="skills">
        ...
        <section id="contact" className="section">
          <h4 className='-rotate-90 absolute -left-10rem font-bold text-6xl text-center translate-y-19rem opacity-40'>DIFFERENT  IS  BETTER<br></br> THAN  GOOD</h4>
          <Contact />
        </section>
      </main>
      <footer>
