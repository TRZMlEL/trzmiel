...
function App() {
  ...
  return (
    <div className='bg-dark w-screen text-light font-Lato'>
      <header className='ml-2rem mr-2rem md:ml-4rem md:mr-4rem lg:ml-8rem lg:mr-8rem h-4rem flex justify-end flex-col'>
      ...
      <main>
        <section className='w-full flex' id='home'>
          ...
          <div className='w-screen pt-2rem pb-2rem md:w-1/2 flex flex-col items-start justify-center md:pl-8rem md:pr-8rem pl-2rem pr-2rem z-10'>
            <p className='text-1xl md:text-2xl lg:text-3xl font-medium'>Hi, my name is</p>
            <h1 className='text-5xl md:text-8xl font-bold tracking-tight'>MATEUSZ<br />TRZMIEL</h1>
            <p className='text-1xl md:text-2xl lg:text-3xl font-medium leading-8'> and I am learning to become a Frontend Developer. In the meantime, alongside programming, I also have a passion for photography.</p>
          </div>
        ...
        <h4 className='hidden lg:block -rotate-90 absolute -left-10rem font-bold text-6xl text-center translate-y-15rem opacity-40'>CREATE WITH ME</h4>
          <div className='z-20 relative w-2/3 pr-1rem pb-1rem'>
            <div className='h-10rem md:h-12rem lg:h-16rem bg-color rounded-lg flex p-1rem md:p-2rem lg:p-4rem justify-center lg:justify-end items-center'>
              <svg className='hidden lg:block absolute -translate-x-20rem translate-y-2rem' width="300" height="300" viewBox="0 0 262 262" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className='w-2/3 h-full flex flex-col items-center justify-center'>
                <p className='text-1xl md:text-3xl text-center font-semibold'>My GitHub profile</p>
                <p className='text-1xl md:text-3xl text-center font-semibold underline underline-offset-2 hover:text-light'><a href='https://github.com/TRZMlEL' target='_blank' rel='noopener noreferrer'>Click here</a></p>
              </div>
            </div>
          </div>
          ...
          <div className='z-20 relative w-3/5 pr-1rem pt-1rem'>
            <div className='h-10rem md:h-12rem lg:h-16rem bg-color rounded-lg flex p-1rem md:p-2rem lg:p-4rem justify-center lg:justify-end items-center'>
              <p className='hidden lg:block absolute font-black -translate-x-8rem translate-y-3rem' style={{ fontSize: '20rem' }}>CV</p>
              <div className='flex flex-col justify-center items-center'>
                <p className='text-1xl md:text-3xl font-semibold'>My CV</p>
                <p className='text-1xl md:text-3xl font-semibold underline underline-offset-2 text-center hover:text-light'><a href='' target='_blank' rel='noopener noreferrer'>Click here</a></p>
              </div>
            </div>
          </div>
          <div className='w-2/5 pl-1rem pt-1rem'>
            <div className='z-0 h-10rem md:h-12rem lg:h-16rem bg-color rounded-lg'>
              <img className='z-10 -translate-x-5rem lg:-translate-x-0rem -translate-y-8rem absolute w-35rem' alt=' ' src={ HexSkillsDecoration }/>
            </div>
          </div>
        </section>
        <section className='z-20 relative section pt-4rem pb-4rem lg:pr-16rem lg:pl-16rem bg-color flex flex-col items-center' id="skills">
          <h2 className='text-dark font-semibold text-4xl leading-none mb-2rem text-center'>LANGUAGES AND TOOLS</h2>
          <div className='flex gap-1rem justify-center flex-wrap' >
            <img className='w-2.5rem md:w-5rem h-full' alt="HTML" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-plain.svg" />
            <img className='w-2.5rem md:w-5rem h-full' alt="CSS" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/css3/css3-plain.svg" />
            <img className='w-2.5rem md:w-5rem h-full' alt="JavaScript" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-plain.svg" />
            <img className='w-2.5rem md:w-5rem h-full' alt="Tailwindcss" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/tailwindcss/tailwindcss-plain.svg" />
            <img className='w-2.5rem md:w-5rem h-full' alt="Git" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/git/git-original.svg" />
            <img className='w-2.5rem md:w-5rem h-full' alt="Figma" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/figma/figma-original.svg" />
            <img className='w-2.5rem md:w-5rem h-full' alt="GitHub" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/github/github-original.svg" />
            <img className='w-2.5rem md:w-5rem h-full' alt="VisualStudioCode" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/vscode/vscode-original.svg" />
            <img className='w-2.5rem md:w-5rem h-full' alt="Linux" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/linux/linux-original.svg" />
          </div>
        </section>
